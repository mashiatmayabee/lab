...
def main():
    ...
    filter1 = cv2.circle(black_img,(m,n),25,(255,255,255),-1)
    filter2 = cv2.circle(white_img,(m,n),25,(0,0,0),-1)
    filter3 = cv2.line(black_img.copy(),(m,0),(m,c),(255,255,255),9)
    filter4 = cv2.line(white_img.copy(),(0,n),(r,n),(0,0,0),9)

    
    ftimg_gf = centeredfti_img * filter1
    filtered_img = np.abs(np.fft.ifft2(ftimg_gf))

    
    img_set = [rgbImg, gray, magnitude_spectrum, centered_magnitude_spectrum, filter1, filtered_img]
